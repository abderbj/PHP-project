...
function RegisterCard() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            console.log(data);
            const response = await axios.post('https://your-api-url.com/signup.php', data);
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="exampleCheck1">By signing up, I agree with the
                                Terms of Use & Privacy Policy</label>
                        </div>
                        <button type="submit" id="RegisterButton" className="btn btn-primary">Register</button>
                        <p className="login-link">Returning user? <a href="/login">Log in here</a></p>
                    </form>
                </div>
            </div>
        </div>
